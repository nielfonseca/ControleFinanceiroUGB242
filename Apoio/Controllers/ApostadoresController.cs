...
{
    public class ApostadoresController : Controller
    {
        private readonly WebetContext _context;

        public ApostadoresController(WebetContext context)
        {
            _context = context;
        }
        ...
        // GET: Apostadores/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Apostadores/Create
